...
if(!selected){
  ...
  return (
    <div id='dateSelect' className='pt-30'>
      <div className='flex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-primary/10 border border-primar/20 rounded-lg'>
      <BlurCircleshade top="-100px" left="-100px" />
      <BlurCircleshade top="100px" left="0px" />
      <div>
